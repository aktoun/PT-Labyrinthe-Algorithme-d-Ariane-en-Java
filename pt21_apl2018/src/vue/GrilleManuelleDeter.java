...
import src.controleur.ToucheEntreeDeter;
import src.vue.background.BackgroundGrilleAlgo;


public class GrilleManuelleDeter extends JFrame {
     ...
     */
    public GrilleManuelleDeter(int[][] typecase, int xThesee, int yThesee, int xSortie, int ySortie, int taille) {
        ...
        ToucheEntreeDeter observateur3 = new ToucheEntreeDeter(this, typecase, xThesee, yThesee, 
